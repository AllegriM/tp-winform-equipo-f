...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="carousel-inner">
                    ...
                    <% foreach (var imagen in detalleArticulo.IMAGEN) { %>
                        <div class="carousel-item <%= isFirst ? "active" : "" %>">
                            <img class="d-block w-100" style="max-height: 205px; min-height: 205px; object-fit: contain;" src="<%: imagen.Url %>" alt="imagen">
                        </div>
                        <% isFirst = false; %>
                    <% } %>
                </div>
        ...
        <% } %>
        <div class="card-body">
            <p class="card-title">$ <%: detalleArticulo.PRECIO.ToString("F2") %></p>
            <h5 class="card-text"><%:detalleArticulo.NOMBRE %></h5>
            <p class="card-text"><%:detalleArticulo.DESCRIPCION %></p>
            <p class="card-subtitle">Cantidad de imágenes: <%: detalleArticulo.CantidadImagenes %></p>
